...
| carré factoriel projections × softmax ± bank-q (FINDINGS 2026-08-03 soir) | quelle forme d'attention-read ? | 🟡 33/48 : **dual_heads ÉLIMINÉ** (Δ nul, coût double, perd le budget m) ; **kvproj BAT kv_append en citation** (+0,227 ±0,125, n=9, croît avec m : m8 2,13 vs 1,79) ; bias softmax appris ≈ 0 (la compétition de masse n'existait pas) ⇒ S1 penche kvproj (l'espace des rotations offert) | 3 kvproj rot-on + 12 bank-q en file ; verdict à max_mem=8, KT8 dira s'il tient |
