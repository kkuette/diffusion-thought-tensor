...
echo "  python -m deepseek_v4_mini.train deepseek_v4_mini/configs/archive/dsv4mini/tiny.yaml"
echo ""
echo "  Memory experiments:"
echo "    configs/archive/dsv4mini/code.yaml          # bank reset per sequence (baseline)"
echo "    configs/archive/dsv4mini/code_persist.yaml  # bank persists across sequences"
echo "    configs/archive/dsv4mini/synth_recall.yaml  # addressable-recall diagnostic"
echo "    configs/archive/dsv4mini/gist.yaml          # latent-context (gist) diagnostic"
